...
const Features = () => {
  ...
  const algorithmSteps = [{
    icon: GitBranch,
    text: t('algorithm.step1')
  }, {
    icon: Zap,
    text: t('algorithm.step2')
  }, {
    icon: Shield,
    text: t('algorithm.step3')
  }, {
    icon: Dna,
    text: t('algorithm.step4')
  }, {
    icon: GitBranch,
    text: t('algorithm.step5')
  }, {
    icon: Shield,
    text: t('algorithm.step6')
  }];
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                return <div key={index} className="bg-white/60 backdrop-blur-sm rounded-lg p-6 text-center">
